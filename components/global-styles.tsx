    ...
    <style jsx global>{`
      ...
      * {
      ...
      @media (max-width: 768px) {
        ...
        /* Mobile Widget Positioning - Stack vertically on the right */
        .widget-hit-counter {
        ...
        /* Mobile Desktop Icons Adjustments */
         .desktop-icon {
         ...
         .desktop-icon .icon {
           font-size: ${Math.max(16, settings.fontSize * 1.8)}px !important;
         }
         ...
         .window-title {
           font-size: ${Math.max(8, settings.fontSize + 1)}px !important;
         }
         ...
         .retro-content h2 {
           font-size: ${Math.max(10, settings.fontSize + 3)}px !important;
         }
         ...
         .game-icon {
           font-size: ${Math.max(20, settings.fontSize * 2.5)}px !important;
         }
